...
- [Git first setup](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#first-time-git-setup)
- [Initializing Repository](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#initializing-repository-in-a-directory)
- [Adding remote origin](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#adding-remote-origin)
- [Branches Introduction](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#branches-introduction)
- [Tracking remote branches](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#tracking-remote-branches)
- [Creating & Pushing branches](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#creating--pushing-branches)
- [Deleting Branches](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#deleting-branches)
- [Fetching Changes](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Git%26Bitbucket.md#fetching-changes)
...
- [Name conventions](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#name-conventions)
- [Getting input from user](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#getting-input-from-user)
- [Common functions](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#common-functions)
- [Getting variable's type](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#getting-variables-type)
- [String practice (immutable)](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#string-practice-immutable---basics)
- [String practice - Slicing](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#string-practice---slicing)
- [Objects and methods practice](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#objects-and-methods-practice)
- [if elif else](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#if-elif-else)
- [Function](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#function---practice)
- [Loops](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#loops---practice)
- [Advanced variable types](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#advanced-variable-types)
    - [List(Mutable & Dynamic)](https://github.com/MaorW/Devops_Cheatsheet/blob/main/Resources/Python.md#list---practice-mutable--dynamic)
